/* tory elmore 
   Audubon Alaska Story Map: "Where We Work
   Code credit to James Carney and Jack Dougherty at Data Viz for All"*/
...
function map() {
    ...
    let lastClickedMarkerLatLon = L.latLng(64.5,-157); //dummy initial data
    ...
    $.ajax("data/iba.geojson", {
        ...
        success: function(response1){
            ...
            var overlayMaps = {
                "Region Boundaries <br> (Click feature for name)": boundaryLG
            };
        ...
        success: function(response){
            ...
            L.geoJson(response, {
                pointToLayer: function (feature, latlng){
                    let chapter = L.circleMarker(latlng, geojsonMarkerOptions);
                    let chapterPopup = "<p><b>Chapter: </b>"+feature.properties.Chapter+ 
                           "<br><b>City: </b>" + feature.properties.City+"</p>"; 
                    chapter.bindPopup(chapterPopup, {
                        closeButton: false
                    });
        ...
        let LegendControl = L.Control.extend({
            ...
            onAdd: function (map) {
                ...
                container.innerHTML = (" <img src=" + label1[0] + " height='20' width='20'>") + " " + icon1[0] +
                        '<br>' + (" <img src=" + label[0] + " height='20' width='20'>") + " " + icon[0] + '<br>';


                // listen for map add/remove layer events
                map.on('overlayadd',function(layer){
                    container.innerHTML = (" <img src=" + label1[0] + " height='20' width='20'>") + " " + icon1[0] +
                        '<br>' + (" <img src=" + label[0] + " height='20' width='20'>") + " " + icon[0] + '<br>' + (" <img src=" + label2[0] + " height='20' width='20'>") + " " + icon2[0] + '<br>';
                });
    ...
    //add boundaries to layer control
    ...
    // function to set up layer control
            ...
            onEachFeature: function (feature, layer) {
                (function(layer, properties) {
                    ...
                    layer.on('click', function() {
                        $("div#contents").animate({scrollTop: (areaTop + 15) + "px"});
                    });
